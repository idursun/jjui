...
<img alt="Fuzzy File Finder" src="/jjui/images/file-search.png" />
...
File paths are displayed relative to the directory where jjui was started. The selected path is still passed to jj and the resulting revset uses the repository-relative file.
...
We use the excellent [`sahilm/fuzzy`](https://github.com/sahilm/fuzzy) library to perform search, which is also used in some charmbracelet UI widgets.
