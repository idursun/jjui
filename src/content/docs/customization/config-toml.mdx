...
You can create a `.jjui/config.toml` file in the root of any jj repo and it will *override* anything that was set by your global config. This allows you to define settings, actions, commands that apply to all repos, but then granularly override particular settings per-repo.
