...
<img alt="Flash Messages" src="/jjui/images/flash messages.png" />
...
To review dismissed messages, press `shift+w` to open the [Command History](/jjui/command-history), which keeps a record of recent commands and their output.
