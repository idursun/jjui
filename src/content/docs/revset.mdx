...
Every revset you apply during a session is saved to history. When you re-open the editor, it defaults to showing your history — use `up`/`down` or `ctrl+p`/`ctrl+n` to navigate it.
