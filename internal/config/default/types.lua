...
---@class jjui.bookmark_view
---@field confirmation jjui.bookmark_view.confirmation
---@field filter jjui.bookmark_view.filter
---@field apply fun()
---@field cancel fun()
---@field create fun()
---@field delete fun()
...
---@class jjui.bookmark_view.confirmation
...
---@class jjui.bookmark_view.filter
---@field apply fun()
---@field cancel fun()
---@field close fun()
...
---@field bookmark_move jjui.revisions.bookmark_move
...
---@class jjui.revisions.bookmark_move
---@field apply fun(args: {force?: boolean})
---@field cancel fun()
---@field force_apply fun()
---@field close fun()
...
---@field quit fun()
---@field suspend fun()
---@field toggle_bookmark_view fun()
---@field close fun()
...
---@field bookmark_view jjui.bookmark_view
