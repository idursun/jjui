...
var scopeDisplayNames = map[string]string{
	...
	"bookmark_pane":                  "Bookmark View",
	"bookmark_pane.confirmation":     "Bookmark View Confirmation",
	"bookmark_pane.filter":           "Bookmark View Filter",
	"git":                            "Git",
...
var scopeOrder = []string{
	...
	"bookmarks.filter",
	"bookmark_pane",
	"bookmark_pane.confirmation",
	"bookmark_pane.filter",
	"git",
	"git.filter",
	"oplog",
	"oplog.quick_search",
