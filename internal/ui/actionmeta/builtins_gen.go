...
var builtInActionScopes = map[string][]string{
	...
	"confirm_immutable.apply":                    {"confirm_immutable"},
	"confirm_immutable.cancel":                   {"confirm_immutable"},
	"confirm_immutable.next":                     {"confirm_immutable"},
	"confirm_immutable.prev":                     {"confirm_immutable"},
