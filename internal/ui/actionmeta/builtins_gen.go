...
var builtInActionScopes = map[string][]string{
	...
	"revisions.bookmark.create":                  {"revisions.bookmark"},
	"revisions.bookmark.delete":                  {"revisions.bookmark"},
	"revisions.bookmark.rename":                  {"revisions.bookmark"},
	"revisions.bookmark.track":                   {"revisions.bookmark"},
	"revisions.bookmark.untrack":                 {"revisions.bookmark"},
	...
	"revisions.details.file.object_next":         {"revisions.details.file"},
	"revisions.details.file.object_prev":         {"revisions.details.file"},
	"revisions.details.move_down":                {"revisions.details"},
	"revisions.details.move_up":                  {"revisions.details"},
	"revisions.details.object_next":              {"revisions.details"},
	"revisions.details.object_prev":              {"revisions.details"},
