...
func (o *Operation) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case tea.KeyMsg:
		...
		case key.Matches(msg, o.keymap.Apply):
			...
			o.context.Revisions.SetCursor(o.search(0))
		...
		case key.Matches(msg, o.keymap.QuickSearchCycle) && o.state == stateApplied:
			o.context.Revisions.SetCursor(o.search(o.context.Revisions.Cursor + 1))
			return o, nil
		}
	}
...
func NewOperation(ctx *context.MainContext) view.IViewModel {
	i := textinput.New()
