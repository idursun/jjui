...
type ILayoutBuilder interface {
	Container(direction ContainerDirection, containers ...ILayoutConstraint) ILayoutConstraint
	VerticalContainer(containers ...ILayoutConstraint) ILayoutConstraint
	HorizontalContainer(containers ...ILayoutConstraint) ILayoutConstraint
	Grow(view ViewId, factor int) ILayoutConstraint
	Fit(view ViewId) ILayoutConstraint
	Percentage(view ViewId, percentage int) ILayoutConstraint
	Floating(view ViewId, anchors ...Anchor) ILayoutConstraint
}

var _ ILayoutBuilder = (*LayoutBuilder)(nil)
